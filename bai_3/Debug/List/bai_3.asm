...
_0x0:
	.DB  0x68,0x65,0x6C,0x6C,0x6F,0x5F,0x77,0x6F
...
_0xB:
	...
	RJMP _0xF
; 0000 0030         {
; 0000 0031             delay_ms(250);
	RCALL SUBOPT_0x0
; 0000 0032             for (i = 5;i >= 0; i--)
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	MOVW R6,R30
_0x11:
